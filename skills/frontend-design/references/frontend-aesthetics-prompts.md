# Frontend Aesthetics Prompt Blocks

Use these blocks as optional guidance when you need stronger aesthetic direction or more controlled outputs.
...
## Theme Constraint Prompt (Example)
